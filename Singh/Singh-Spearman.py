...
if __name__=='__main__':
    ...
    # Set minimum Spearman threshold
    minCor = 0.61
    ...
    plt.savefig('Singh-Spearman-NetworkModel-' + str(minCor) + '.png', dpi=500)
    plt.show()
    time_end2 = time.time()

    with open('Singh-Spearman-AssociationRules-' + str(minCor) + '.csv', 'w', newline='') as f:
        f_csv = csv.writer(f)
    ...
    with open('Singh-Spearman-PositiveEdges-' + str(minCor) + '.csv', 'w', newline='') as f:
        f_csv = csv.writer(f)
        f_csv.writerows(posuedge)
    with open('Singh-Spearman-NegativeEdges-' + str(minCor) + '.csv', 'w', newline='') as f:
        f_csv = csv.writer(f)
