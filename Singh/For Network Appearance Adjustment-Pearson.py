...
with open("Singh-Pearson-PositiveEdges-0.75.csv",'r',newline='') as f:
    f_csv = csv.reader(f)
    for item in f_csv:
        posuedge.append(item)

with open("Singh-Pearson-NegativeEdges-0.75.csv",'r',newline='') as f:
    f_csv = csv.reader(f)
    for item in f_csv:
...
plt.savefig('Singh-Pearson-NetworkModel-DrawNetworks.png',dpi=500)
plt.show()
