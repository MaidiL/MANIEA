...
title = ['index', 'g__Howardella', 'g__Ruminococcus2', 'g__Clostridium_XI', 'g__Roseburia', 'g__Anaerostipes', 'g__Streptococcus', 'g__Blautia', 'g__Oscillibacter', 'g__Bacteroides', 'g__Desulfovibrio', 'g__Dorea', 'g__Turicibacter', 'g__Prevotella', 'g__Clostridium_sensu_stricto', 'g__Ruminococcus', 'g__Erysipelotrichaceae_incertae_sedis', 'g__Subdoligranulum', 'g__Anaerotruncus', 'g__Lachnospiracea_incertae_sedis', 'g__Coprococcus', 'g__Oribacterium', 'g__Parabacteroides', 'g__Megamonas', 'g__Anaerovibrio', 'g__Anaerovorax', 'g__Lachnospira', 'g__Catenibacterium', 'g__Dialister', 'g__Paraprevotella', 'g__Pseudoflavonifractor', 'g__Butyricicoccus', 'g__Alistipes', 'g__Sutterella', 'g__Collinsella', 'g__Clostridium_IV', 'g__Elusimicrobium', 'g__Clostridium_XlVa', 'g__Odoribacter', 'g__Flavonifractor', 'g__Eggerthella', 'g__Akkermansia', 'g__Haemophilus', 'g__Sporobacter', 'g__Butyrivibrio', 'g__Clostridium_XVIII', 'g__Xylanibacter']

uedge = []
dedge = []

with open("Zupancic-Apriori-UndirectedEdges-0.4-0.6-0.9.csv",'r',newline='') as f:
    f_csv = csv.reader(f)
    for item in f_csv:
        uedge.append([title[eval(item[0])].lstrip('g__'),title[eval(item[1])].lstrip('g__')])

with open("Zupancic-Apriori-DirectedEdges-0.4-0.6-0.9.csv",'r',newline='') as f:
    f_csv = csv.reader(f)
    for item in f_csv:
...
# colorDict = {'Lachnospiraceae':'lightblue','Prevotellaceae':'rosybrown','Enterobacteriaceae':'plum','Porphyromonadaceae':'chocolate','Bacteroidaceae':'yellow','Veillonellaceae':'greenyellow','Ruminococcaceae':'coral','Rikenellaceae':'green','Verrucomicrobiaceae':'mediumpurple','Peptostreptococcaceae':'red','Streptococcaceae':'cyan','Erysipelotrichaceae':'brown'}
...
nx.draw(D, with_labels=False, node_size=de2, node_color=colorLs2, alpha=1, linewidths=3,
        ...
        pos=position)
plt.savefig('Zupancic-Apriori-HealthNetwork-DrawNetworks.png',dpi=500)
plt.show()
...
with open('Zupancic-Apriori-Drawnetworks-IndividualIndexes.csv', 'w', newline='') as f:
    f_csv = csv.writer(f)
