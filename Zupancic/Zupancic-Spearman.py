...
if __name__=='__main__':
    ...
    plt.savefig('Zupancic-Spearman-NetworkModel-' + str(minCor) + '.png', dpi=500)
    plt.show()
    time_end2 = time.time()

    with open('Zupancic-Spearman-AssociationRules-'+str(minCor)+'.csv', 'w', newline='') as f:
        f_csv = csv.writer(f)
    ...
    with open('Zupancic-Spearman-PositiveEdges-' + str(minCor) + '.csv', 'w', newline='') as f:
        f_csv = csv.writer(f)
        f_csv.writerows(posuedge)
    with open('Zupancic-Spearman-NegativeEdges-' + str(minCor) + '.csv', 'w', newline='') as f:
        f_csv = csv.writer(f)
