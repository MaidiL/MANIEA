...
with open("Zupancic-Pearson-PositiveEdges-0.37.csv",'r',newline='') as f:
    f_csv = csv.reader(f)
    for item in f_csv:
        posuedge.append(item)

with open("Zupancic-Pearson-NegativeEdges-0.37.csv",'r',newline='') as f:
    f_csv = csv.reader(f)
    for item in f_csv:
...
plt.savefig('Zupancic-Pearson-NetworkModel-DrawNetworks.png',dpi=500)
plt.show()
