...
if __name__ == '__main__':
    ...
    plt.savefig('Baxter-MANIEA-NetworkModel-' + str(minSup) + '-' + str(minConf) + '-' + str(minCor) + '.png',
                dpi=500)
    plt.show()

    with open('Baxter-MANIEA-AssociationRules-' + str(minSup) + '-' + str(minConf) + '-' + str(minCor) + '.csv', 'w',
              newline='') as f:
        f_csv = csv.writer(f)
    ...
    with open('Baxter-MANIEA-UndirectedEdges-' + str(minSup) + '-' + str(minConf) + '-' + str(minCor) + '.csv', 'w',
              newline='') as f:
        f_csv = csv.writer(f)
        f_csv.writerows(uedge)

    with open('Baxter-MANIEA-PositiveDirectedEdges-' + str(minSup) + '-' + str(minConf) + '-' + str(minCor) + '.csv',
              'w', newline='') as f:
        f_csv = csv.writer(f)
        f_csv.writerows(posDedge)

    with open('Baxter-MANIEA-NegativeDirectedEdges-' + str(minSup) + '-' + str(minConf) + '-' + str(minCor) + '.csv',
              'w', newline='') as f:
        f_csv = csv.writer(f)
