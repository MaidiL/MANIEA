...
with open("Baxter-Pearson-PositiveEdges-0.59.csv",'r',newline='') as f:
    f_csv = csv.reader(f)
    for item in f_csv:
        posuedge.append(item)

with open("Baxter-Pearson-NegativeEdges-0.59.csv",'r',newline='') as f:
    f_csv = csv.reader(f)
    for item in f_csv:
...
plt.savefig('Baxter-Pearson-NetworkModel-DrawNetworks.png',dpi=500)
plt.show()
